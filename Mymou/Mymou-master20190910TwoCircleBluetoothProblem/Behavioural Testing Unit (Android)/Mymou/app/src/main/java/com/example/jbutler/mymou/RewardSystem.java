...
//    private static String address = "FC:A6:21:D8:11:E5";//三星平板设备MAC地址
    //蓝牙地址必须6个字节，必须大写；
//    private static String address = "98:D3:31:FD:24:E1";//Arduino Uno HC-06设备连接的蓝牙接收发射的地址；现在在6楼
    private static String address = "98:D3:71:FD:46:23";//HC-05楼下新蓝牙；
//    private static String address = "98:D3:81:FD:44:85";//Arduino Uno HC-
// 05设备连接的蓝牙接收发射的地址；可以通过这种注释切换
