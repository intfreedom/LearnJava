...
public class TaskExample extends Fragment
   ...
   /*getView为fragment布局获得 根View*/
    ...
    private void calculateCueLocations() {
        ...
        xCenter -= 100;  //changeDon'tMove  change Move  changeReward
        int screenHeight = size.y;
        int yCenter = screenHeight / 2;
        yCenter -= 200; //changeDon'tMove  change Move  changeReward
...
//                randomiseNoReplacement(cues_O);//changetask-onePicture //changeDon'tMove note
    ...
    private static void timerCancerGreen() {
        h4.postDelayed(new Runnable() {
            ...
            public void run() {
                randomiseCueLocations();//changeDon'tMove  change Move  changeReward
                //fixedCueLocations();//changeDon'tMove  change Move  changeReward
//                randomiseNoReplacement(cues_O);//changetask-onePicture //changeDon'tMove note
